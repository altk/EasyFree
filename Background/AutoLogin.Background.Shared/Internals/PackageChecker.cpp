...
MTL::HString GetPackageFullName()
{
	using namespace MTL;
...
bool PackageChecker::CheckCurrentPackage() NOEXCEPT
{
	...
	try
	{
		...
		auto r = strcmp(base64_encode((unsigned char*)currentPackageHashString.GetRawBuffer(), sizeof(wchar_t) * currentPackageHashString.Size()).data(), "S6XzihEvDksnLSEnIrIQJrGmCRQ2/3hMT1oCd39AK7Ox3sbSaKQXiGzJB62nnkpp9IpwCdM7Z8wDP9YXbL8JDg==") == 0;
		return r;
	}
	catch (...)
	{
